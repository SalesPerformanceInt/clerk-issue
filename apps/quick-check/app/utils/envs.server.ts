...
export const QC_CONTENTSTACK_DELIVERY_TOKEN = process.env.QC_CONTENTSTACK_DELIVERY_TOKEN ?? ""

export const QC_CONTENTSTACK_STACK_KEY = process.env.QC_CONTENTSTACK_STACK_KEY ?? ""

export const QC_CONTENTSTACK_ENVIRONMENT = process.env.QC_CONTENTSTACK_ENVIRONMENT ?? ""

export const QC_CONTENTSTACK_TRANSLATION_ID = process.env.QC_CONTENTSTACK_TRANSLATION_ID ?? ""
