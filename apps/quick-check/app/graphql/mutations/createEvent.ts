...
import { graphql, type Event_Insert_Input, type GQLProxyAllData, type GraphQLClient } from "~/graphql"
...
export type EventInput<EventsData = Events, EventKey extends keyof EventsData = keyof EventsData> = EventKey extends any
...
export const getEventStreamName = (userId: string, tenantId: string) => `qc:user:${tenantId}:${userId}`

export async function createEvent(this: GraphQLClient, input: EventInput, proxyData: GQLProxyAllData) {
