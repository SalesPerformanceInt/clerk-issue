...
import { graphql, type GQLProxyUserData, type GraphQLClient, type User_Set_Input } from "~/graphql"
...
export async function updateUser(this: GraphQLClient, set: User_Set_Input, proxyData: GQLProxyUserData) {
