...
type EnrollmentSkillDashboardProps = {
  enrollmentSkillDashboard: EnrollmentSkillDashboardData &
    EnrollmentSkillDashboardContextProps;
};

export const EnrollmentSkillDashboard: FC<EnrollmentSkillDashboardProps> = ({
    ...
    >
      ...
      <ResponsiveContainer className="p-4 pb-8" asChild>
        <main>
          ...
          <EnrollmentSkillSectionSuspense
            skillQuestionsPromise={enrollmentSkillDashboardQuestions}
          />
