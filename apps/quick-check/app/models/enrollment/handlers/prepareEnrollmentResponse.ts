...
const enrollmentResponseMessagesMap = new MatchedMap<EnrollmentResponseCodes, string>([
...
export const prepareEnrollmentIgnored = (message?: string) => prepareEnrollmentResponse({ status: 208, message })

export const prepareEnrollmentRejected = (message?: string) => prepareEnrollmentResponse({ status: 400, message })

export const prepareEnrollmentError = (message?: string) => prepareEnrollmentResponse({ status: 500, message })
