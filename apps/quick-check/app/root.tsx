...
export const loader = async ({ request }: LoaderFunctionArgs) => {
  ...
  const [timeTravelFlag = false, accelerateEnabledFlag = false] = await getSplit(request, [
...
export default function App() {
  const { theme, locale, ENV, now, isAdminEnabled, featureFlags } = useLoaderData<typeof loader>()
