...
import { getAdminDataFromFromSession, getDeleteCookieHeaders } from "~/models/session"

import { Landing, landingActionValidator, type LandingActionResponse } from "~/pages/Landing"
...
export const action = async ({ request }: ActionFunctionArgs) => {
  const result = await landingActionValidator.validate(await request.formData())
