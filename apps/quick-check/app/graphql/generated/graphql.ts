...
export type CreateUserMutation = { __typename?: 'mutation_root', insert_user_one?: { __typename: 'user', account: string, email: string, first_name: string, language_preference: string, last_name: string, next_question_id?: string | null, phone_number?: string | null, timezone: string, user_id: UUID, sms_enabled: boolean, learning_records: Array<{ __typename: 'learning_record', created_at: TIMESTAMPTZ, data: JSONB, event_type: string, id: UUID, user_id: UUID }> } | null };
...
export type UpdateNextQuestionIdMutation = { __typename?: 'mutation_root', update_user_by_pk?: { __typename: 'user', account: string, email: string, first_name: string, language_preference: string, last_name: string, next_question_id?: string | null, phone_number?: string | null, timezone: string, user_id: UUID, sms_enabled: boolean, learning_records: Array<{ __typename: 'learning_record', created_at: TIMESTAMPTZ, data: JSONB, event_type: string, id: UUID, user_id: UUID }> } | null };
...
export type GetLinkTokenQuery = { __typename?: 'query_root', link_token_by_pk?: { __typename?: 'link_token', id: string, user_id: UUID, created_at: TIMESTAMPTZ, active: boolean, user: { __typename: 'user', account: string, email: string, first_name: string, language_preference: string, last_name: string, next_question_id?: string | null, phone_number?: string | null, timezone: string, user_id: UUID, sms_enabled: boolean, learning_records: Array<{ __typename: 'learning_record', created_at: TIMESTAMPTZ, data: JSONB, event_type: string, id: UUID, user_id: UUID }> } } | null };
