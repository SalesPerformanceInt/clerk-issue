...
export type BaseUserEnrollmentFragment = { __typename: 'user_enrollment', id: Uuid, user_id: Uuid, tenant_id: string, taxonomy_id: string, created_at: TimestampTZ, score: number };
...
export type UpdateUserQuestionMutationVariables = Exact<{
  ...
  inc?: InputMaybe<User_Question_Inc_Input>;
}>;
