...
export const LandingExpiredLink: FC = () => {
  const { t } = useTranslation();

  return (
    <div className="flex flex-col gap-4">
      <p className="mb-4 text-3xxl font-semibold">
        {t("landing.check_your_email")}
      </p>
      <div className="flex items-center gap-6">
        <Icon
          icon={faEnvelopeCircleCheck}
          className="!text-3xxl text-primary-50"
        />
        <p className="font-bold">{t("landing.expired")}</p>
      </div>
