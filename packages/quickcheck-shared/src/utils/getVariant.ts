import type { QuestionItemByTaxonomy, QuestionItemVariant } from "~qcs/contentstack"
...
export const getVariant = <V extends Variant>(questionItem: QuestionItem | QuestionItemByTaxonomy, variant: V) => {
  const questionVariant = questionItem.variants.find((_variant) => variant in _variant)
