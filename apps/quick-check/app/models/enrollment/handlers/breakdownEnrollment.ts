...
export const breakdownEnrollment = ({
  ...
  if (newEnrollment)
    return { newEnrollment, startDateStatus, expirationDateStatus };

  if (isDefined.strict(prohibitedUpdateStatus))
    return { prohibitedUpdateStatus };
