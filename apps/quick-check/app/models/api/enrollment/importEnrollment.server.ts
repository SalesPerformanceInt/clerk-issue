...
const ZOD_DATE_REGEX_ARGS = [/^\d{4}-(0[1-9]|1[012])-(0[1-9]|[12][0-9]|3[0-1])$/, { message: "invalid date" }] as const
...
export const inputEnrollmentSchema = z.object({
  ...
  expiration_date: zfd.text(z.string().regex(...ZOD_DATE_REGEX_ARGS)).nullable(),
})
