...
import { invariant, Question, simpleErrorResponse, type OnSubmit } from "quickcheck-shared"
...
export default function QuestionPage() {
  ...
  const onClose = courseId ? () => navigate(`/content/${language}/course/${courseId}`) : onReload
