...
export const Support: FC = () => {
  ...
  return (
    <Tooltip
      ...
      contentClassName={twMerge("bg-background p-0 z-20 shadow-card", isDesktop ? "mr-6" : "mr-4")}
      closeButton={false}
      texts={[
        <LinkButton className="bg-background px-4 py-3 text-text" href={SUPPORT_URL} target="_blank">
