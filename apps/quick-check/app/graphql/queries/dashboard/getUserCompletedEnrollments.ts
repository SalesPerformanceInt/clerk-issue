...
export async function getUserCompletedEnrollments(this: GraphQLClient, proxyData: GQLProxyUserData) {
  try {
...
export type UserDashboardCompletedEnrollments = NonNullable<Awaited<ReturnType<typeof getUserCompletedEnrollments>>>
