...
export type GetActiveUserQuestionQuery = { __typename?: 'query_root', user_question: Array<{ __typename: 'user_question', id: Uuid, user_id: Uuid, tenant_id: string, taxonomy_id: string, question_id: string, retired_on?: TimestampTZ | null, active_on?: TimestampTZ | null, created_at: TimestampTZ, streak: number, difficulty: Numeric, latest_review_gap: number, last_answered_on?: TimestampTZ | null, attempts: { __typename?: 'user_answer_aggregate', aggregate?: { __typename?: 'user_answer_aggregate_fields', count: number } | null }, user_enrollment: { __typename: 'user_enrollment', id: Uuid, user_id: Uuid, tenant_id: string, taxonomy_id: string, created_at: TimestampTZ, score: number } }> };
