...
export const PercentageBar: FC<PercentageBarProps> = ({ percent, empty, ariaLabel }) => {
  if (empty)
    return (
  ...
  return (
    <Progress className="h-6 overflow-hidden rounded-full" value={percent} aria-label={ariaLabel}>
      <ProgressIndicator
        className={twMerge(
