...
export type EnrollUserMutation = { __typename?: 'mutation_root', insert_user_enrollment_one?: { __typename: 'user_enrollment', id: Uuid, user_id: Uuid, taxonomy_id: string, created_at: TimestampTZ, score: number, rank?: number | null, start_date: ISODate, expiration_date: ISODate, user: { __typename?: 'user', user_id: Uuid, tenant_id: string, language_preference: string, email: string, first_name: string, last_name: string }, first_question: Array<{ __typename: 'user_question', id: Uuid, user_id: Uuid, taxonomy_id: string, question_id: string, retired_on?: ISODate | null, active_on?: ISODate | null, created_at: TimestampTZ, streak: number, difficulty: Numeric, latest_review_gap: number, last_answered_on?: ISODate | null, attempts: { __typename?: 'user_answer_aggregate', aggregate?: { __typename?: 'user_answer_aggregate_fields', count: number } | null }, user_enrollment: { __typename: 'user_enrollment', id: Uuid, user_id: Uuid, taxonomy_id: string, created_at: TimestampTZ, score: number, rank?: number | null, start_date: ISODate, expiration_date: ISODate }, user: { __typename?: 'user', user_id: Uuid, language_preference: string } }> } | null, insert_tenant_one?: { __typename?: 'tenant', tenant_id: string, theme_id: string } | null };
...
export type ResetUserMutation = { __typename?: 'mutation_root', update_user_by_pk?: { __typename: 'user', tenant_id: string, email: string, first_name: string, last_name: string, language_preference: string, timezone: string, user_id: Uuid, sms_enabled: boolean, daily_email_enabled: boolean, phone_number?: string | null, next_question?: { __typename: 'user_question', id: Uuid, user_id: Uuid, taxonomy_id: string, question_id: string, retired_on?: ISODate | null, active_on?: ISODate | null, created_at: TimestampTZ, streak: number, difficulty: Numeric, latest_review_gap: number, last_answered_on?: ISODate | null, attempts: { __typename?: 'user_answer_aggregate', aggregate?: { __typename?: 'user_answer_aggregate_fields', count: number } | null }, user_enrollment: { __typename: 'user_enrollment', id: Uuid, user_id: Uuid, taxonomy_id: string, created_at: TimestampTZ, score: number, rank?: number | null, start_date: ISODate, expiration_date: ISODate }, user: { __typename?: 'user', user_id: Uuid, language_preference: string } } | null } | null, delete_learning_record?: { __typename?: 'learning_record_mutation_response', affected_rows: number } | null, delete_user_enrollment?: { __typename?: 'user_enrollment_mutation_response', affected_rows: number } | null };
...
export type UnenrollUserMutation = { __typename?: 'mutation_root', update_user_by_pk?: { __typename: 'user', tenant_id: string, email: string, first_name: string, last_name: string, language_preference: string, timezone: string, user_id: Uuid, sms_enabled: boolean, daily_email_enabled: boolean, phone_number?: string | null, next_question?: { __typename: 'user_question', id: Uuid, user_id: Uuid, taxonomy_id: string, question_id: string, retired_on?: ISODate | null, active_on?: ISODate | null, created_at: TimestampTZ, streak: number, difficulty: Numeric, latest_review_gap: number, last_answered_on?: ISODate | null, attempts: { __typename?: 'user_answer_aggregate', aggregate?: { __typename?: 'user_answer_aggregate_fields', count: number } | null }, user_enrollment: { __typename: 'user_enrollment', id: Uuid, user_id: Uuid, taxonomy_id: string, created_at: TimestampTZ, score: number, rank?: number | null, start_date: ISODate, expiration_date: ISODate }, user: { __typename?: 'user', user_id: Uuid, language_preference: string } } | null } | null, delete_user_enrollment?: { __typename?: 'user_enrollment_mutation_response', affected_rows: number } | null };
...
export type UpsertUserMutation = { __typename?: 'mutation_root', insert_user_one?: { __typename: 'user', tenant_id: string, email: string, first_name: string, last_name: string, language_preference: string, timezone: string, user_id: Uuid, sms_enabled: boolean, daily_email_enabled: boolean, phone_number?: string | null, active_tokens: Array<{ __typename: 'link_token', id: string, created_at: TimestampTZ, active: boolean, user_id: Uuid }>, next_question?: { __typename: 'user_question', id: Uuid, user_id: Uuid, taxonomy_id: string, question_id: string, retired_on?: ISODate | null, active_on?: ISODate | null, created_at: TimestampTZ, streak: number, difficulty: Numeric, latest_review_gap: number, last_answered_on?: ISODate | null, attempts: { __typename?: 'user_answer_aggregate', aggregate?: { __typename?: 'user_answer_aggregate_fields', count: number } | null }, user_enrollment: { __typename: 'user_enrollment', id: Uuid, user_id: Uuid, taxonomy_id: string, created_at: TimestampTZ, score: number, rank?: number | null, start_date: ISODate, expiration_date: ISODate }, user: { __typename?: 'user', user_id: Uuid, language_preference: string } } | null } | null, insert_tenant_one?: { __typename?: 'tenant', tenant_id: string, theme_id: string } | null };
...
export type GetUserDashboardDataQuery = { __typename?: 'query_root', user_by_pk?: { __typename: 'user', tenant_id: string, email: string, first_name: string, last_name: string, language_preference: string, timezone: string, user_id: Uuid, sms_enabled: boolean, daily_email_enabled: boolean, phone_number?: string | null, next_question?: { __typename: 'user_question', id: Uuid, user_id: Uuid, taxonomy_id: string, question_id: string, retired_on?: ISODate | null, active_on?: ISODate | null, created_at: TimestampTZ, streak: number, difficulty: Numeric, latest_review_gap: number, last_answered_on?: ISODate | null, attempts: { __typename?: 'user_answer_aggregate', aggregate?: { __typename?: 'user_answer_aggregate_fields', count: number } | null }, user_enrollment: { __typename: 'user_enrollment', id: Uuid, user_id: Uuid, taxonomy_id: string, created_at: TimestampTZ, score: number, rank?: number | null, start_date: ISODate, expiration_date: ISODate }, user: { __typename?: 'user', user_id: Uuid, language_preference: string } } | null, active_enrollments: { __typename?: 'user_enrollment_aggregate', aggregate?: { __typename?: 'user_enrollment_aggregate_fields', count: number } | null }, unanswered_questions: { __typename?: 'user_question_aggregate', aggregate?: { __typename?: 'user_question_aggregate_fields', count: number } | null } } | null };
...
export type GetRankeableEnrollmentsQuery = { __typename?: 'query_root', user_enrollment: Array<{ __typename: 'user_enrollment', id: Uuid, user_id: Uuid, taxonomy_id: string, created_at: TimestampTZ, score: number, rank?: number | null, start_date: ISODate, expiration_date: ISODate, user: { __typename?: 'user', first_name: string, last_name: string, tenant_id: string, language_preference: string } }> };
