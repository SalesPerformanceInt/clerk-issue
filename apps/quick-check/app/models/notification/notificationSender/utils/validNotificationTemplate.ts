...
const getUserInactiveTemplate = ({
  user,
  now,
}: ValidNotificationTemplateProps): null | NotificationTemplate => {
...
const getQuestionActivatedTemplate = ({
  user,
}: ValidNotificationTemplateProps): null | NotificationTemplate => {
...
const possibleNotificationTemplates = [
  getUserInactiveTemplate,
  getUserAwayTemplate,
  getQuestionActivatedTemplate,
];

export const getFirstValidNotificationTemplate = ({
  user,
  now,
}: ValidNotificationTemplateProps) => {
  const notificationTemplate = possibleNotificationTemplates.find((template) =>
    template({ user, now }),
  );
